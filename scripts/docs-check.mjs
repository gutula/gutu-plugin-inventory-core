...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/inventory-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-inventory-core:");
...
console.log("Documentation check passed for gutu-plugin-inventory-core.");
